...
export function GithubStats() {
        ...
        <div className="flex flex-col items-center justify-center h-[400px] border border-border rounded-lg bg-card/50 gap-4">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              우측 상단의 <span className="inline-flex items-center gap-1 font-medium text-foreground"><Settings className="w-3 h-3" />깃허브 설정</span> 버튼을 눌러 계정을 연결하세요
            </p>
          </div>
        </div>
      </div>
  ...
  const weeklyData = [
    { id: "mon", day: "월", commits: 3 },
    { id: "tue", day: "화", commits: 5 },
    { id: "wed", day: "수", commits: 2 },
    { id: "thu", day: "목", commits: 7 },
    { id: "fri", day: "금", commits: 4 },
    { id: "sat", day: "토", commits: 6 },
    { id: "sun", day: "일", commits: 1 },
  ];
  ...
  const contributionGrid = Array.from({ length: 52 }, (_, week) =>
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          {githubConfig ? `@${githubConfig.username} · 커밋 기록 및 활동 현황` : "커밋 기록 및 활동 현황"}
        </p>
      </div>
